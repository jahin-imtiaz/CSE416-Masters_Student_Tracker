    ...
    <b-container lg="10" offset="1" class="bv-example-row">
      <b-container fluid>
        ...
        <b-row lg="10">
          ...
          <b-col>
            <b-row>
              <b-col
                >Selected file: {{ courseFile ? courseFile.name : "" }}</b-col
              >
              <b-col
      ...
      <b-row class="mt-3">
        ...
        <b-col>
          <b-row>
            <b-col
              >Selected file:
              {{ degreeReqFile ? degreeReqFile.name : "" }}</b-col
            >
            <b-col
      ...
      <b-row class="mt-3">
        ...
        <b-col>
          <b-row>
            <b-col
              >Selected file:
              {{ courseOfferingFile ? courseOfferingFile.name : "" }}</b-col
            >
            <b-col
      ...
      <b-row class="mt-3">
        ...
        <b-col>
          <b-row>
            <b-col
              >Selected file: {{ studentFile ? studentFile.name : "" }}</b-col
            >
            <b-col
      ...
      <b-row>
        ...
        <b-col>
          <b-row>
            <b-col
              >Selected file:
              {{ coursePlanFile ? coursePlanFile.name : "" }}</b-col
            >
            <b-col
      ...
      <b-row class="mt-3">
        ...
        <b-col>
          <b-row>
            <b-col
              >Selected file: {{ gradesFile ? gradesFile.name : "" }}</b-col
            >
            <b-col
  ...
  methods: {
    ...
    loadStudentFile() {
      ...
      reader.onload = (e) => {
        ...
        console.log(VUE_APP_BACKEND_API)
